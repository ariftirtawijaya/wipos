        ...
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                if (version_compare(PHP_VERSION, '8.1') >= 0) {
                    ...
                    $ltext .= '<i class="fa fa-close"></i>WiPOS needs at least PHP version  8.1, Your PHP Version is: ' . PHP_VERSION . '<br/>';
                    $passed .= '0';
                }
                ...
                <br/><?php echo $ltext; ?><br/><h4>Great! System Test Completed. You can run WiPOS on your server. Click Continue For Next Step.</h4>
                <a href="step3.php" class="btn btn-primary">Continue</a>

                <?php else: ?>

                <br/><?php echo $ltext; ?><br/>Sorry. The requirements of WiPOS is not available on your server. Please contact with us- hello@witek.id with this code- <?php echo $passed; ?> Or contact with your server administrator.<br><br>
